...
import com.treevalue.robot.exception.BalanceNotEnoughException;
import com.treevalue.robot.resource.model.Account;
import com.treevalue.robot.resource.repository.AccountRepository;
...
public class AccountController {
	...
	public Account withdraw(@PathVariable("id") Long id, @PathVariable("amount") int amount) throws JsonProcessingException, BalanceNotEnoughException {
